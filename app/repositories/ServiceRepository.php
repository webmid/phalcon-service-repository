...
class ServiceRepository implements RepositoryInterface
{
    ...
    public function findOrFail($id): Model
    {
        if (!$record = $this->model->findFirst(["id = :value:", 'bind' => ['value' => $id]])) {
            throw new \Exception("Caught ModelNotFoundException in " . __METHOD__ . ' at line ' . __LINE__ . ': Model not found.');
        }
    ...
    public function firstOrFail(): Model
    {
        if (!$record = $this->model->findFirst()) {
            throw new \Exception("Caught ModelNotFoundException in " . __METHOD__ . ' at line ' . __LINE__ . ': No models found.');
        }
    ...
    public function firstOrFailBy(array $where = []): Model
    {
        ...
        if (!$model) {
            throw new \Exception("Caught ModelNotFoundException in " . __METHOD__ . ' at line ' . __LINE__ . ': No model found.');
        }
